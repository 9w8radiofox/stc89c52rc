      ...
      000003 02 00 62         [24]  346 	ljmp	_main
                                    ...
                                    357 ;------------------------------------------------------------
                                    358 ;	src/main.c:3: int main(void){
                                    359 ;	-----------------------------------------
                                    360 ;	 function main
                                    361 ;	-----------------------------------------
      000062                        362 _main:
                           ...
                           000001   369 	ar1 = 0x01
                           000000   370 	ar0 = 0x00
                                    371 ;	src/main.c:5: P2 = 0xFF;
      000062 75 A0 FF         [24]  372 	mov	_P2,#0xff
                                    373 ;	src/main.c:6: for(int i = 20000; i>0;i--){};
      000065 7E 20            [12]  374 	mov	r6,#0x20
      000067 7F 4E            [12]  375 	mov	r7,#0x4e
      000069                        376 00104$:
      000069 C3               [12]  377 	clr	c
      00006A E4               [12]  378 	clr	a
      00006B 9E               [12]  379 	subb	a,r6
      00006C 74 80            [12]  380 	mov	a,#(0x00 ^ 0x80)
      00006E 8F F0            [24]  381 	mov	b,r7
      000070 63 F0 80         [24]  382 	xrl	b,#0x80
      000073 95 F0            [12]  383 	subb	a,b
      000075 50 07            [24]  384 	jnc	00101$
      000077 1E               [12]  385 	dec	r6
      000078 BE FF 01         [24]  386 	cjne	r6,#0xff,00130$
      00007B 1F               [12]  387 	dec	r7
      00007C                        388 00130$:
      00007C 80 EB            [24]  389 	sjmp	00104$
      00007E                        390 00101$:
                                    391 ;	src/main.c:8: P2 = 0x00;
      00007E 75 A0 00         [24]  392 	mov	_P2,#0x00
                                    393 ;	src/main.c:9: for(int i = 5000; i>0;i--){};
      000081 7E 88            [12]  394 	mov	r6,#0x88
      000083 7F 13            [12]  395 	mov	r7,#0x13
      000085                        396 00107$:
      000085 C3               [12]  397 	clr	c
      000086 E4               [12]  398 	clr	a
      000087 9E               [12]  399 	subb	a,r6
      000088 74 80            [12]  400 	mov	a,#(0x00 ^ 0x80)
      00008A 8F F0            [24]  401 	mov	b,r7
      00008C 63 F0 80         [24]  402 	xrl	b,#0x80
      00008F 95 F0            [12]  403 	subb	a,b
      000091 50 07            [24]  404 	jnc	00102$
      000093 1E               [12]  405 	dec	r6
      000094 BE FF 01         [24]  406 	cjne	r6,#0xff,00132$
      000097 1F               [12]  407 	dec	r7
      000098                        408 00132$:
      000098 80 EB            [24]  409 	sjmp	00107$
      00009A                        410 00102$:
                                    411 ;	src/main.c:11: return 0;
      00009A 90 00 00         [24]  412 	mov	dptr,#0x0000
                                    413 ;	src/main.c:12: }
      00009D 22               [24]  414 	ret
                                    415 	.area CSEG    (CODE)
                                    416 	.area CONST   (CODE)
                                    417 	.area XINIT   (CODE)
